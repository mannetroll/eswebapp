...
public class ElasticServiceImpl implements ElasticService {
            ...
            if (execute != null) {
                ...
                if (errorMessage == null) {
                    ...
                    for (Hit<HashMap, Void> hit : hits) {
                        @SuppressWarnings("unchecked") final Map<String, Object> hitMap = hit.source;
    ...
    public EdiToStartResponse edi2Start(String consignor) {
        ...
        try {
            ...
            long elapsed = Duration.between(start, Instant.now()).toMillis();
            Map<String, Object> lmap = new HashMap<String, Object>();
            lmap.put(LogKeys.DESCRIPTION, "consignor: " + consignor + ", elapsed: " + elapsed);
    ...
    public ArrivalCompletedResponse arrivalCompleted(String spid, Integer percentile, DateTime date, Integer weeks) {
        ...
        try {
            ...
            long elapsed = Duration.between(start, Instant.now()).toMillis();
            Map<String, Object> lmap = new HashMap<String, Object>();
            lmap.put(LogKeys.DESCRIPTION, "arrivalcompleted: " + spid + ", elapsed: " + elapsed);
            lmap.put("spid", spid);
            lmap.put("elapsed", elapsed);
            LOG.info(lmap);
        } catch (IOException e) {
    ...
    public PopularTimesResponse popularTimes(String spid, String countryCode, DateTime fromDay, DateTime toDay) {
        ...
        try {
            ...
            long elapsed = Duration.between(start, Instant.now()).toMillis();
            Map<String, Object> lmap = new HashMap<String, Object>();
            lmap.put(LogKeys.DESCRIPTION, "populartimes: " + spid + ", elapsed: " + elapsed);
            lmap.put("spid", spid);
            lmap.put("elapsed", elapsed);
            LOG.info(lmap);
        } catch (IOException e) {
    ...
    public EdiPressureStatusResponse ediPressureStatus() {
        ...
        try {
            ...
            long elapsed = Duration.between(start, Instant.now()).toMillis();
            Map<String, Object> lmap = new HashMap<String, Object>();
            lmap.put(LogKeys.DESCRIPTION, "ediPressureStatus: elapsed: " + elapsed);
            lmap.put("elapsed", elapsed);
            LOG.info(lmap);
        } catch (IOException e) {
            LOG.error(e.getMessage(), e);
