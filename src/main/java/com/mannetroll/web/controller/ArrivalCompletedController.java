...
public class ArrivalCompletedController {
    ...
    public ResponseEntity<ArrivalCompletedResponse> arrivalCompletedDayOfWeek(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String spid, @ApiParam(value = "DayOfWeek")
    @PathVariable("dayofweek")
    Integer dayofweek, @ApiParam(value = "Percentile")
    @RequestParam(value = "percentile", required = false)
    Integer percentile) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_DAY_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ElasticService.ARRIVALCOMPLETED);
        try {
            if (percentile == null || percentile < 0 || percentile > 100) {
                percentile = defaultPercentile;
            }
            //
            // ArrivalCompletedResponse data = elasticService.arrivalCompleted(spid, dayofweek, percentile);
    ...
    public ResponseEntity<ArrivalCompletedResponse> arrivalCompleted(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String spid, @ApiParam(value = "Percentile")
    @RequestParam(value = "percentile", required = false)
    Integer percentile) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ElasticService.ARRIVALCOMPLETED);
        try {
            if (percentile == null || percentile < 0 || percentile > 100) {
                percentile = defaultPercentile;
    ...
    public ResponseEntity<ArrivalCompletedResponse> arrivalCompletedParam(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String spid, @ApiParam(value = "percentile")
    @PathVariable("percentile")
    Integer percentile, @ApiParam(value = "date")
    @PathVariable("date")
    Integer date, @ApiParam(value = "weeks")
    @PathVariable("weeks")
    Integer weeks) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ElasticService.ARRIVALCOMPLETED);
        try {
            if (weeks < 1 || weeks > 52) {
    ...
    public ResponseEntity<ArrivalCompletedResponse> arrivalCompletedDayOfWeek2(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String spid, @ApiParam(value = "DayOfWeek")
    @PathVariable("dayofweek")
    Integer dayofweek) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ElasticService.ARRIVALCOMPLETED + "2");
        try {
    ...
    public ResponseEntity<ArrivalCompletedResponse> arrivalCompleted2(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String spid) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ElasticService.ARRIVALCOMPLETED + "2");
        try {
    ...
    public ResponseEntity<ArrivalCompletedStatusResponse> arrivalCompletedStatus() throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_STATUS_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ARRIVALCOMPLETED_STATUS);
        try {
    ...
    public void arrivalCompletedExport(@RequestParam(value = "size", required = false)
    Integer size, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_EXPORT_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ARRIVALCOMPLETED_EXPORT);
        if (size == null) {
            size = 100;
        }
        ...
        lmap.put(LogKeys.DESCRIPTION, "arrivalCompletedStatus: elapsed: " + elapsed);
    ...
    public void arrivalCompletedIds(@ApiParam(value = "ServicePointID")
    @PathVariable("spid")
    String[] spid, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_LIST_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ARRIVALCOMPLETED_LIST);
        final Instant start = Instant.now();
        ServletOutputStream out = response.getOutputStream();
        Long loop = 1L;
        //columns
        ...
        long elapsed = Duration.between(start, Instant.now()).toMillis();
        Map<String, Object> lmap = new HashMap<String, Object>();
        lmap.put(LogKeys.DESCRIPTION, "arrivalcompletedids: elapsed: " + elapsed);
        lmap.put("elapsed", elapsed);
        LOGGER.info(lmap);
    }
    ...
    public ResponseEntity<Map<String, Object>> arrivalcompletedcache() throws IOException {
        ThreadContext.put(Constants.METRICS_NAME, ARRIVALCOMPLETED_CACHE_URI);
        ThreadContext.put(Constants.JAVA_METHOD, ARRIVALCOMPLETED_CACHE);
